...
genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))  # Configure Google Generative AI, put the API key in .env file
...
(the exact answer based on the question)
...
# reduce model creativity & focus on factual accuracy
    model = ChatGoogleGenerativeAI(model="gemini-pro", temperature=0.5) #use temperature at 0.5
